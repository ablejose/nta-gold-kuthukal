...
export const BRAND: BrandConfig = {
  businessName: "NTA GOLD",
  tagline: "Your Trusted Jewellery Destination in Manjeri",
  description:
    "NTA GOLD is Manjeri's trusted destination for gold, diamond, and silver jewellery. Serving Manjeri and the surrounding areas with timeless craftsmanship and a wide collection to suit every celebration and every budget.",
  ...
  address: "Pandikkad Road, Kuthukal, Manjeri, Kerala 676123",
  city: "Manjeri",
  state: "Kerala",
  pincode: "676123",

  phone: "+918086800916",
  whatsapp: "918086800916",
  email: "",

  mapsLink:
    "https://www.google.com/maps/search/?api=1&query=NTA%20GOLD&query_place_id=ChIJv6WvNmU2pjsRO9YFCqkJiJQ",
  ...
  seo: {
    title: "NTA GOLD | Gold & Jewellery in Manjeri",
    description:
      "NTA GOLD — Manjeri's destination for gold, diamond and silver jewellery. Beautiful collections for every celebration. Manjeri, Kerala.",
    keywords: [
      "NTA GOLD",
      "jewellery Manjeri",
    ...
    canonical: "https://nta-gold-kuthukal.vercel.app",
    ogImage:
      "/images/store1.webp",
  },
  ...
  whatsappMessage:
    "Hello NTA GOLD, I'd like to know more about your jewellery collections.",
};
